<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashboardsalesman.aspx.cs" Inherits="dashboardsalesman" %>
...
<body>
    ...
    <div class="style1" 
        ...
        <table class="style12" frame="void" 
            ...
            style="border-top: thin solid #000000; padding-top: 20px; position: relative; left: 0px; width: 100%; right: 0px; top: 3px; table-layout: auto; border-collapse: collapse; border-spacing: 0px; margin-bottom: 0px;">
            <tr>
