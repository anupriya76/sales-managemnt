<%@ Page Language="C#" AutoEventWireup="true" CodeFile="salesmansales.aspx.cs" Inherits="salesman_salesmansales" %>
...
<body>
    ...
    <div class="style1" 
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="style8" 
            Font-Size="24px" Height="20px" Width="240px">Update</asp:HyperLink>
                    <br />
        </strong>
                    <hr class="style15" />
                </td>
        ...
        <asp:HyperLink ID="HyperLink3" runat="server" CssClass="style2" 
            Font-Size="24px" Height="26px" Width="240px" NavigateUrl="~/salesman/Per.aspx">Sales Record</asp:HyperLink>
                    <br />
        </strong>
                    <hr class="style16" />
                </td>
