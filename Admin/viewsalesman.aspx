...
<body>
    ...
    <div class="style1" 
        ...
        <table class="style12" frame="void" 
            ...
            style="border-top: thin solid #000000; padding-top: 20px; position: relative; left: 0px; width: 100%; right: -113px; top: 3px; table-layout: auto; border-collapse: collapse; border-spacing: 0px;">
            <tr>
            ...
            Height="20px" NavigateUrl="~/Admin/Addsalesman.aspx" Width="240px">Add Salesman</asp:HyperLink>
                ...
                <td rowspan="5"  
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM [salesman]"></asp:SqlDataSource>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
        ...
        <asp:HyperLink ID="HyperLink3" runat="server" CssClass="style2" 
            Font-Size="24px" Height="26px" Width="240px">Update Salesman</asp:HyperLink>
                    <br />
        </strong>
                    <hr class="style16" />
                </td>
