...
<body>
    ...
    <div class="style1" >
        ...
        <asp:Chart ID="Chart1" runat="server" AlternateText="No data Availbale" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [date], [quantity], [superid], [pname] FROM [productorder] WHERE ([superid] = @superid)">
            <SelectParameters>
                <asp:SessionParameter Name="superid" SessionField="id" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
