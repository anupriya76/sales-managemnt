...
<body style="height: 149px; margin-bottom: 24px">
    ...
    <div>
        ...
        <div class="style4" 
            ...
            <br />
            <strong><span class="style5">View Products </span></strong><span class="style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
            </span>
            <br class="style6" />
        </div>
    ...
    <table class="style8">
                ...
                <asp:Panel ID="Panel1" runat="server" Height="306px" style="padding-left: 41px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:CommandField ButtonType="Button" HeaderText="Action" SelectText="View" 
        ...
        <asp:HyperLink ID="HyperLink3" runat="server" CssClass="style2" 
            Font-Size="24px" Height="20px" Width="240px" 
                    NavigateUrl="~/Admin/viewproduct.aspx"> UpdateProduct</asp:HyperLink>
                <br />
                    <hr class="style14" />
        </strong>
                    </td>
    ...
    <asp:Panel ID="Panel2" runat="server" class="style20"  CssClass="modalPopup" Style="display: none">
