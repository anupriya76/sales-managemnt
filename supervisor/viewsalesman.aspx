...
<body>
    ...
    <div class="style1" 
        ...
        <table class="style12" frame="void" 
            ...
            style="border-top: thin solid #000000; padding-top: 20px; position: relative; left: 0px; width: 100%; right: 187px; top: 3px; table-layout: auto; border-collapse: collapse; border-spacing: 0px;">
            <tr>
                <td class="style18" style="border-collapse: collapse" 
                    >
                    <strong>
                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="style8" Font-Size="24px" 
            Height="20px" NavigateUrl="~/supervisor/Addsalesman.aspx" Width="240px">Add Salesman</asp:HyperLink>
                    <br />
        </strong>
                    <hr class="style14" />
                </td>
                <td rowspan="5"  
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM [salesman] WHERE ([supervisor_id] = @supervisor_id)">
                        <SelectParameters>
                            <asp:SessionParameter Name="supervisor_id" SessionField="id" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="style8" 
            Font-Size="24px" Height="20px" Width="240px" 
                        NavigateUrl="~/supervisor/viewsalesman.aspx">View Salesman</asp:HyperLink>
                    <br />
        </strong>
                    <hr class="style15" />
                </td>
        ...
        <asp:HyperLink ID="HyperLink4" runat="server" CssClass="style2" 
            Font-Size="24px" Height="26px" Width="240px" 
                     NavigateUrl="~/supervisor/disablesalesman.aspx">Disable Salesman</asp:HyperLink>
                    <br />
        </strong>
                    <hr class="style16" />
                </td>
