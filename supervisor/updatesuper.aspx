<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updatesuper.aspx.cs" Inherits="supervisor_updatesuper" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" BackgroundCssClass="modalBackground" runat="server" TargetControlID="LinkButton1" PopupControlID="Panel1" CancelControlID="Button3">
